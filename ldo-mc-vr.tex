...
those using VR parameters from standard quadrature set types for a collection of engineering test problems that have angular streaming features that challenges the CADIS and \fwc\ methods. Most are neutron problems and one is a photon problem. Using the LDO equations to create variance reduction parameters with the
