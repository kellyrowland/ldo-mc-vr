...
\begin{table}[!hbt]
\centering
\caption{\fwc\ FOM values for representative quadratures for the DLVN problem, with best performance at each detector indicated with bold font.}
% I don't know why this isn't centered anymore... sorry!
...
\centering
\small
\caption{\fwc\ FOM values for representative quadratures for the portal monitor, with best performance at each detector indicated with bold font.}
