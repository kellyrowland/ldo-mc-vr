...
The Lagrange Discrete Ordinates (LDO) equations retain the formal structure of
...
effects at increased angular resolutions; hybrid methods that combine
deterministic and stochastic solutions often fall short in shielding problems
with highly anisotropic particle movement and particle streaming pathways. In
this work, we assess the LDO equations' scalar flux solutions as input in the
