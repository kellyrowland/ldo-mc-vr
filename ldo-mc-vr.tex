...
scenario, we are intested in the flux solutions at the end of the steel plate.
...
work. We are interested in the flux solutions at the various detector
...
In Figure \ref{p1}, the different colors represent different materials. The
NaI detectors are red and the gray material is concrete. The two types of
material blocks are iron, shown in green, and polyethylene, shown in white.
The steel cargo container surrounds the particle source and material blocks
and is a semitransparent blue. Here we are interested in the flux solutions at
the four detector locations.
...
side indicating the one standard deviation confidence interval. Recall that
1\E{9} neutron histories were used in these calculations.
...
are not included here. Again, 1\E{9} neutron histories were used here.
...
experiment. Note that 1\E{10} particle histories were simulated in the Monte
Carlo calculations. Figure \ref{dlvn-cad-tally} shows the MCNP-reported tally
for the forward scalar flux at the location of detector \#14;. Here we see
that all of the biased calculation values fall within the error of the
unbiased result. However, all of these tally calculations (biased and
unbiased) do not match the experimentally calculated flux value of 2.74\E{-7}
$\pm$ 5\% n/cm$^2$/s at detector \#14.
...
problem. Recall that 1\E{10} neutron histories were simulated for the DLVN
tests.
...
small array. Here, 1\E{9} particle histories were used in the Monte Carlo
calculations.
...
detector locations in the problem's detector array. Again, 1\E{9} photon
histories were used in the calculations here.
