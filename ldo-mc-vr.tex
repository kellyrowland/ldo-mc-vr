...
Additionally, it is instructive to look
...
various quadrature sets and orders. The VR parameters corresponding to the
LDFE quadrature set of order 1 result in the highest FOM value while those of
the QR set of order 1 result in the lowest FOM value.
...
forward scalar flux at the location of detector \#14.
