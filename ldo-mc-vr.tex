...
circumstances, we still compare performance in terms of FOM. The motivation is
that, with enough simulated particles, a correct solution would be obtained.
Therefore, a better FOM should still indicate which method to choose to get
