...
equations in Section II. Test case scenarios are then described with relevant calculation
...
When solving the steady-state Boltzmann transport equation shown in Equation
\eqref{eq:bte}, using deterministic
...
This approximation gives one equation for each angle,
index $n$:
%
\begin{multline}
