...
ordinates (\sn) equations. We conclude the section by highlighting the
differences in treatment of the angular variable and scattering between the
two formulations to motivate the work undertaken.
...
angular mesh refinement used in the deterministic calculations used to produce
scalar flux solutions for Monte Carlo variance reduction parameter generation.
